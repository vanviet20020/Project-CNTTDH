...
class Cinema(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    id_supplier = db.Column(db.Integer, db.ForeignKey(
...
class Movie_showtime(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    id_cinema = db.Column(db.Integer, db.ForeignKey(
        'cinemas.id'), nullable=False)
    id_movie = db.Column(db.Integer, db.ForeignKey(
...
class Evaluate(db.Model):
    ...
    user = db.relationship(
        'User', back_populates='evaluates', cascade='all,delete')
    cinema = db.relationship(
        'Cinema', back_populates='evaluates', cascade='all,delete')
...
class Supplier(db.Model):
    ...
    cinema = db.relationship(
        'Cinema', back_populates='supplier', cascade='all,delete')
